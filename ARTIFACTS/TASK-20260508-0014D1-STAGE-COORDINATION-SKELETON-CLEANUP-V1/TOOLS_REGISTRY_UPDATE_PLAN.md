...
Runtime activation: REQUIRES_IMPLEMENTATION
...
Registry policy for this cleanup pack:
...
Activation gate:
A tool may move from SKELETON_CONTRACT to ACTIVE_NEEDS_SPECULUM only after 0014E implementation + local tests + registry hash verification + Speculum review.
