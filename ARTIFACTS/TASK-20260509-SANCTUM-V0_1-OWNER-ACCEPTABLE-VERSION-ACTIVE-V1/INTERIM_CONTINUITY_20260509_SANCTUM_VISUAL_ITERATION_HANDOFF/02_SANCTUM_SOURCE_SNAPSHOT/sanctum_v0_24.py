...
class SanctumApp(tk.Tk):
    ...
    def draw_route_map(self, model):
        ...
        c.create_rectangle(34, 34, w - 34, 274, fill=COLORS["panel3"], outline=COLORS["line"], width=1)
    ...
    def draw_stage_map(self, model):
        ...
        c.create_rectangle(34, 34, w - 34, 186, fill=COLORS["panel3"], outline=COLORS["line"], width=1)
    ...
    def save_status_files(self):
        ...
        status = {
            "sanctum_version": "0.24",
            "status": "PREMIUM_MISSION_CONTROL_HUD_EXPERIMENT",
        ...
        readme = """# IMPERIUM Sanctum v0.24

STATUS: MISSION_CONTROL_HUD_EXPERIMENT
