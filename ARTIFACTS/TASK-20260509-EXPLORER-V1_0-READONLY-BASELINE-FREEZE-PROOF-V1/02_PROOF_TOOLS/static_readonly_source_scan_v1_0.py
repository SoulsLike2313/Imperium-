...
SOURCE = Path(r"E:\IMPERIUM\EXPLORER\imperium_explorer_v1_0.py")
...
def main():
    ...
    report = {
        "scan_name": "EXPLORER_V1_0_STATIC_READ_ONLY_SOURCE_SCAN",
    ...
    json_path = OUT_ROOT / "EXPLORER_V1_0_STATIC_READ_ONLY_SCAN_REPORT.json"
    md_path = OUT_ROOT / "EXPLORER_V1_0_STATIC_READ_ONLY_SCAN_REPORT.md"

    json_path.write_text(json.dumps(report, ensure_ascii=False, indent=2), encoding="utf-8")

    lines = [
        "# Explorer V1.0 Static Read-Only Source Scan",
        "",
        f"Source: `{SOURCE}`",
        f"Verdict: `{verdict}`",
        "",
