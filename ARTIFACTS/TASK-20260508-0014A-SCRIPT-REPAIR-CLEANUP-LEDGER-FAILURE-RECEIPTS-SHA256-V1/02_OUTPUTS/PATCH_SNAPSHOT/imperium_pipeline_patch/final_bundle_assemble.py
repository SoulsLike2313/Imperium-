...
from lib.sha256_utils import file_sha256, write_sha256_file, write_single_sha256_file  # noqa: E402
...
def main() -> int:
    ...
    comments = [
        ...
        "На неуспехе формируется FINAL_ASSEMBLY_RECEIPT и пишется STAGE_FAILED событие в ledger.",
        "Внешний .sha256 теперь записывается в portable формате с именем файла без абсолютного пути.",
