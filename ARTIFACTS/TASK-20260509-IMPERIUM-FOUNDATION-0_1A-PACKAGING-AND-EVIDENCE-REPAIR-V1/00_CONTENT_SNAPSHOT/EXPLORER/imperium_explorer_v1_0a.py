...
APP_NAME = "IMPERIUM Explorer V1.0A Read-Only Baseline Candidate"
...
class ImperiumExplorer(tk.Tk):
    ...
    def _show_details(self, path: Path):
        ...
        if self.selected_node_type == "ARCHIVE_COLD_STORAGE":
            lines.append("")
            ...
            lines.append("ARCHIVE_MANUAL_BROWSING: INSPECTION_ONLY_NOT_ACTIVE_HISTORY")
    ...
    def _animate_visual_panel(self):
        ...
        c.create_text(
            cx,
            h - 18,
            text="IMPERIUM EXPLORER V1.0A / READ ONLY BASELINE CANDIDATE",
            fill="#5ebce8",
            font=("Consolas", 9),
        )
