...
def main() -> int:
    ...
    required_files = [
        ...
        "PAST_STATE_INDEX.json",
        "CURRENT_STATE_INDEX.json",
        "FUTURE_STATE_INDEX.json",
        "ORGANS_INDEX.json",
        "ASTRONOMICON_INDEX.json",
        "SANCTUM_READINESS_INDEX.json",
        ...
        "EXECUTOR_RUN_RECEIPT.json",
    ]
    missing_required = [name for name in required_files if not (pack_dir / name).exists()]
    ...
    receipt_status = None
    receipt_path = pack_dir / "EXECUTOR_RUN_RECEIPT.json"
    if receipt_path.exists():
        rec, err = read_json_safe(receipt_path)
    ...
    payload: Dict[str, Any] = {
        ...
        "executor_receipt_status": receipt_status,
        "verdict": verdict,
        "no_vm2_contact": True,
        "no_real_e2e": True,
        "no_throne": True,
    ...
    lines = [
        ...
        f"executor_receipt_status: {receipt_status}",
        f"verdict: {verdict}",
    ]
