...
from ledger_utils import append_event, read_ledger  # noqa: E402
...
from provenance_utils import validate_provenance  # noqa: E402
from sha256_utils import parse_sha256_file  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        receipt_payload = {
            ...
            "barrier_result": barrier_result,
            "status": verdict,
            "failure_reason": "; ".join(reasons_fail + reasons_waiting + reasons_conflict) if verdict != "PASS" else "",
