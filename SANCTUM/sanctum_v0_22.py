...
class SanctumApp(tk.Tk):
    ...
    def draw_route_map(self, model):
        ...
        c.create_rectangle(34, 34, w - 34, 176, fill=COLORS["panel3"], outline=COLORS["line"], width=1)
    ...
    def draw_stage_map(self, model):
        ...
        for st in stages:
            ...
            c.create_text(60, y+100, anchor="nw", fill=COLORS["accent"], font=("Consolas", 9, "bold"), text="expected artifacts:")
