...
CRITICAL_PATHS = [
    ...
    EXPLORER_ROOT / "imperium_explorer_v1_0.py",
...
def build_markdown_report(report: dict) -> str:
    lines = []
    lines.append("# IMPERIUM Explorer Truth Audit V1.0")
    lines.append("")
...
def main():
    run_id = "RUN-V1_0-" + datetime.now().strftime("%Y%m%d-%H%M%S")
    ...
    report = {
        "audit_name": "IMPERIUM_EXPLORER_TRUTH_AUDIT_V1_0",
        "run_id": run_id,
    ...
    print("Explorer truth audit v1.0 complete.")
