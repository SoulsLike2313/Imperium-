...
3. Scoped verdict
`PASS_FOR_VM3_CONTOUR_INITIATION_VALIDATION_ONLY`

4. Direct PC->VM3 route proof verdict
...
- Canonical route registration across full Administratum/Mechanicus registries.
- Expected hash match confirmation from PC-side source.
- Any production/autonomy claims beyond this contour-initiation slice.
