...
Вердикт: `BOOTSTRAP_HARDENING_PARTIAL`
...
- Чистый PASS не заявлен: сохраняются `CAP_STAGE1_WITH_WARNINGS_ONLY` и `CAP_EXTERNAL_FINALIZATION_RECEIPT_MISSING_OR_PENDING`.
