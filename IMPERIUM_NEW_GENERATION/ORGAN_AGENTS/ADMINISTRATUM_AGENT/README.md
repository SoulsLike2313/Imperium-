...
- verify, stamp, ledger, quarantine, and fetch manual PC-to-VM2 transfer bundles.
...
- `python IMPERIUM_NEW_GENERATION/ORGAN_AGENTS/ADMINISTRATUM_AGENT/TOOLS/administratum_agent_runner.py --no-color transfer-fetch-vm2 --task-id <TASK_ID> --expected-filename <TASK_ID>__VM2_RESPONSE_BUNDLE.zip`
