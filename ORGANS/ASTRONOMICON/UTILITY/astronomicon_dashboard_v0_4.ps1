...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
        Title="IMPERIUM :: ASTRONOMICON DASHBOARD v0.4"
        Height="980"
        Width="1640"
        WindowStartupLocation="CenterScreen"
        Background="#070B15"
        ...
        <Border Grid.Column="0" CornerRadius="18" Background="#0D1426" BorderBrush="#273858" BorderThickness="1" Margin="0,0,10,0">
            <DockPanel Margin="16">
                <StackPanel DockPanel.Dock="Top">
                    ...
                    <TextBlock Text="Speculum loop v0.4" Foreground="#8DA7FF" Margin="0,4,0,16"/>
        ...
        <Border Grid.Column="1" CornerRadius="18" Background="#0A1020" BorderBrush="#273858" BorderThickness="1" Margin="0,0,10,0">
            <Grid Margin="18">
                ...
                <StackPanel Grid.Row="0" Margin="0,0,0,16">
                    ...
                    <TextBlock Text="General Task → Local Tasks → Speculum refinements → Stages next." Foreground="#8FA2CC" Margin="0,5,0,0"/>
                </StackPanel>
                ...
                <Grid Grid.Row="1">
                    ...
                    <Border Grid.Row="2" CornerRadius="22" Background="#0E172C" BorderBrush="#33405E" BorderThickness="1" Padding="14" Margin="80,0,80,12" Opacity="0.88">
                        <StackPanel HorizontalAlignment="Center" VerticalAlignment="Center">
                            ...
                            <TextBlock Text="Empty in v0.4. Next: Decompose selected LTASK to stages, then export stages to Speculum." Foreground="#A8B8DD" TextAlignment="Center" TextWrapping="Wrap" Margin="0,8,0,0"/>
                        </StackPanel>
                    </Border>
...
$btnExportLocalSpeculum.Add_Click({
    try {
        ...
        $Result = & powershell.exe -ExecutionPolicy Bypass -File $script:ExportLocalTasksPath `
            -OutputRoot $script:CurrentOutputRoot 2>&1 | Out-String
...
$btnImportLocalSpeculum.Add_Click({
    try {
        ...
        $Result = & powershell.exe -ExecutionPolicy Bypass -File $script:ImportLocalTaskRefinementsPath `
            -OutputRoot $script:CurrentOutputRoot `
            -RefinementsPath $DefaultRefPath 2>&1 | Out-String
...
$Window.Add_ContentRendered({
    Status "Dashboard v0.4 ready. Speculum Local Task export/import buttons are wired."
})
