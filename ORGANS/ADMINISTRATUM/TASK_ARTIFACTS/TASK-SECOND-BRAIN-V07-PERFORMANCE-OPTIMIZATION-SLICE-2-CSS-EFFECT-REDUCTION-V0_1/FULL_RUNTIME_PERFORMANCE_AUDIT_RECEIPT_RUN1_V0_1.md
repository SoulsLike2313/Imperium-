...
- generated_at: `2026-05-17T20:58:56+00:00`
...
- /api/status: code=`200` elapsed_ms=`3.49` ok=`True`
- /api/snapshot: code=`200` elapsed_ms=`2.04` ok=`True`
- /api/tasks: code=`200` elapsed_ms=`1.8` ok=`True`
- /api/task_packages: code=`200` elapsed_ms=`14.25` ok=`True`
- /api/export/status: code=`200` elapsed_ms=`3.62` ok=`True`
...
- isolation_root: `C:/Users/PC/AppData/Local/Temp/imperium_runtime_audits/full_runtime_audit_20260517_205852_11180`
